...
Future<bool> initDependencies() async {
  try {
    ...
    final partTypesState = Get.put(PartTypesState());
    await partTypesState.getAll();
    Get.put(PartEditorState());
    Get.put(LocationEditorState());
    Get.put(LocationsMenuState());
    final locationsState = Get.put(LocationManagerState());
    await locationsState.getAllLocations();
